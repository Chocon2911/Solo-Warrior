...
public class PlayerJump : HuyMonoBehaviour
{
    ...
    protected virtual void Jumping()
    {
        ...
        if(this.playerCtrl.Rb2D.velocity.y < 0)
        {
            this.playerCtrl.Rb2D.velocity -= this.vecGravity * fallMultiplier * Time.deltaTime;
        }
    ...
    {
        this.playerCtrl.Rb2D.velocity = new Vector2(playerCtrl.Rb2D.velocity.x, jumpHeight);
    }
}
